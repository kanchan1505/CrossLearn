...
public class DictionaryListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userTextView.setText(getIntent().getStringExtra(Main2Activity.USER_NAME_STRING)+"'s Dictionary");
        ...
        sharedPreferences=getSharedPreferences(Main2Activity.SHARED_NAME_STRING, MODE_PRIVATE);
        ...
        searchButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String sp=""+string.charAt(0);
                sp=sp.toUpperCase();

                string=string.replace(string.charAt(0)+"",sp);
