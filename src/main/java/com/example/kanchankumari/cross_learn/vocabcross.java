...
public class vocabcross extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vocabcross);
        ...
        b[6][7].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (word.equals("CONCEDE")) {
                    mf.add(word);
                    Toast.makeText(vocabcross.this, "CONCEDE - admit to be true ; grant (a right,privilege, etc) ", Toast.LENGTH_LONG).show();
        ...
        b[9][9].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (word.equals("DISQUIET")) {
                    mf.add(word);
                    Toast.makeText(vocabcross.this, "DISQUIET - make uneasy or anxious", Toast.LENGTH_LONG).show();
        ...
        b[9][8].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (word.equals("INDICT")) {
                    ...
                    mf.add(word);
                    Toast.makeText(vocabcross.this, "INDICT - charge ", Toast.LENGTH_LONG).show();
        ...
        b[6][5].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (word.equals("MARRED")) {
                    mf.add(word);
                    Toast.makeText(vocabcross.this, "MARRED - damaged ; disfigured ", Toast.LENGTH_LONG).show();
        ...
        b[2][9].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (word.equals("NUANCE")) {
                    mf.add(word);
                    Toast.makeText(vocabcross.this, "NUANCE - shade of difference in meaning or color; subtle distinction ", Toast.LENGTH_LONG).show();
        ...
        b[1][6].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (word.equals("OBVIATE")) {
                    mf.add(word);
                    Toast.makeText(vocabcross.this, " OBVIATE- make unnecessary ; get rid of. ", Toast.LENGTH_LONG).show();
        ...
        b[8][1].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (word.equals("VACUOUS")) {
                    mf.add(word);
                    Toast.makeText(vocabcross.this, "VACUOUS - empty ; inane", Toast.LENGTH_LONG).show();
...
sub.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View view) {
        if(count==7)
        {
           Toast.makeText(vocabcross.this,"You have found all the words",Toast.LENGTH_LONG).show();
        }
        else
        {
            Toast.makeText(vocabcross.this,"You have not found all the words",Toast.LENGTH_LONG).show();
        }
    }
});
